      ...
      {loading ? (
        ...
        <ul className="space-y-4">
          {reviews.map((review, index) => (
            <li
              key={index}
              className="flex items-start p-4 border border-gray-300 rounded-lg shadow-sm bg-white"
            >
              <img
              ...
              <div className="flex-1">
                <div className="flex items-center mb-2">
                  <div className="text-lg font-semibold text-gray-900 mr-4">{review.username}</div>
