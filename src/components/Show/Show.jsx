        ...
        <div className="relative z-10 container mx-auto px-4 py-12 mt-10 pb-32">
          ...
          <div className="p-8 max-w-4xl mx-auto text-black rounded-3xl shadow-2xl  border border-white border-opacity-20">
            ...
            <CheckTsunami
              lat={lat}
              lon={long}
              tsunamiRating={tsunamiRating}
              setTsunamiRating={setTsunamiRating}
            />
            <section>
              <h2 className="text-4xl font-bold text-white text-center mb-8 tracking-wide text-shadow-lg"></h2>
              <Alerts
                district={district}
                currentSpeed={currentSpeed}
            ...
            <div className="bg-white bg-opacity-10 p-6 rounded-2xl backdrop-blur-md mb-8">
              <div className="text-md font-semibold mb-4">
                <Descript data={JSON.stringify(weatherData)} />
              </div>
            </div>
          </div>
          {/* Alerts Section */}
