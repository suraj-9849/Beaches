      ...
      <div className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-md">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">Fill in the details to organize your event</p>
          </div>
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="rounded-md shadow-sm -space-y-px">
              <div className="mb-4">
                ...
                />
                {errors.ngoName && (
                  <p className="mt-1 text-xs text-red-500">{errors.ngoName.message}</p>
                )}
              </div>
              ...
              <div className="flex space-x-4 mb-4">
                <div className="flex-1">
                  ...
                  {errors.timeFrom && (
                    <p className="mt-1 text-xs text-red-500">{errors.timeFrom.message}</p>
                  )}
                </div>
                <div className="flex-1">
                  ...
                  {errors.timeTo && (
                    <p className="mt-1 text-xs text-red-500">{errors.timeTo.message}</p>
                  )}
                </div>
              </div>
              <div className="mb-4">
