    ...
    <header className="fixed top-0 left-0 w-full bg-gradient-to-r from-blue-400 to-emerald-400 shadow-md z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-[8vh] flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          <GoogleTranslate />
          <Link to='/alerts' className="text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white p-2 rounded-full transition-colors">
            <Bell size={24} />
          </Link>
          {user ? (
            ...
            <Link to='/login' className="text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white p-2 rounded-full transition-colors">
              <User size={24} />
            </Link>
          )}
