...
">
  S H O R E S 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <button className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold py-3 px-8 rounded-full transition-transform duration-300 ease-in-out flex items-center hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl" onClick={() => window.location.href = '/search'}>
            <Umbrella className="mr-2" />
            Explore Beaches
          </button>
          <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-full transition-transform duration-300 ease-in-out flex items-center hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl" onClick={() => window.location.href = '/events'} >
